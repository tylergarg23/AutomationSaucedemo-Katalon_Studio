...
WebUI.click(findTestObject('Object Repository/Carrito_Page/button_Add to cart'))

WebUI.click(findTestObject('Object Repository/Carrito_Page/button_Add to cart_1'))

WebUI.click(findTestObject('Object Repository/Carrito_Page/a_2'))

WebUI.click(findTestObject('Object Repository/Carrito_Page/span_Your Cart'))

WebUI.takeScreenshot('D:/2024/Projects QA/Katalon - Automation/Project-Saucedemo/Imagenes/test1.png')
